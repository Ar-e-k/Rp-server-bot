...
class country:
    ...
    def __init__(self, name, overwrite, economy, expenses, army, education, manuals, manuals2, public):
        ...
        all=self.read_stats("World_priv(backup)(copy).csv")
        self.name=name
        #print(self.name)
        all=all[self.name]
        self.basics={}
        ...
        self.economy={}
        self.economy["Pop_ratio"]={"Rural":0, "Artisan":0, "Unemployed":0, "Young":0, "Army":0}
    ...
    def update_save(self):
        ...
        if error==None:
            ...
            return error
        self.edit_stats("World_priv(backup)(copy).csv")
        return None
    ...
    def update_per_income(self): #Updates income per Rural and Artisan population
        self.update_ratio()
        self.incomes={}
        self.incomes["Rural"]=self.get_income_class("Rural", "Rural")
        self.incomes["Artisan"]=self.get_income_class("Artisan", "Artisan")
    ...
    def change_name(self, value):
        value=self.edit_name("World_priv(backup)(copy).csv", value)
    ...
    def change(self, source, value, admin=False):
        ...
        for cat in self.all:
            if source in cat.keys():
                cat[source]=value
        #self.edit_stats_value("World_priv(backup)(copy).csv", value, source)
    ...
    def get_avarage_pay(self):
        ...
        work_pop=float(pop_ratio["Rural"])+float(pop_ratio["Artisan"])
